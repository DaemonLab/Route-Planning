        ...
        for cnt in contours:
            ...
            if area> area_thres:
                ...
                if len(approx)== 3:
                    ...
                    print(avg_gradient)
                    if (avg_gradient) < 0.35:
                        print("Cylinder")
                        print("area",area/sq_scaling)
                        print("vol",(area/sq_scaling)*height)
                        cv2.putText(bg_removed,"cylinder",(cx,cy),font,1,(0,0,0)) 
                        print(" Sending data ...") 
                    else:
                        print("Sphere")
                        cv2.putText(bg_removed,"sphere",(cx,cy),font,1,(0,0,0))  
                        print("area",area/sq_scaling)
            ...
            #cv2.imshow('imgdil',bg_removed)
            # cv2.imshow('imgdil',frame)
