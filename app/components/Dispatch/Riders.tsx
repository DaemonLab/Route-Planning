  ...
  const [showConfirmModal, setShowConfirmModal] = React.useState(false);
    ...
    return (
      <div className="bg-black">
        {props.ridersList === undefined ? (<h1>Loading!!</h1>) : (<div>{showInfoModal ? (
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl px-2">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-2 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="p-1 text-xl font-semibold">Task Information</h3>
                  <button
          ...
          <div className="mx-auto w-full max-w-5xl pt-8 pb-16">
            ...
            <ul className="flex flex-col">
              {props.ridersList.map((item: any) => (
                <li key={item.rider_id} className="border-b-2 border-gray-100">
                  <div
