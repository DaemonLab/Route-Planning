...
function Navbar() {
  ...
  return (
    <div>
      <nav class="relative px-4 py-4 flex justify-between items-center bg-[#111111]">
        ...
        <a
          class="hidden lg:inline-block py-2 px-6 bg-[#544ef1] hover:bg-[#544ef1] text-sm text-white font-bold rounded-md transition duration-200"
          href="#"
        >
          Logout
        </a>
      ...
      <div class="navbar-menu relative z-50 hidden">
        ...
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div class="mt-auto">
            <div class="pt-6">
              <a
                class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-[#544ef1] hover:bg-blue-700  rounded-xl"
                href="#"
              >
                Logout
              </a>
