...
function AddCsv() {
    ...
    const handleSubmit = ()=>{
      ...
      if(!(columns.length===4 && columns[0]['name']==='Email' && columns[1]['name']==='Name' && columns[2]['name']==='D_O_B' && columns[3]['name']==='Phone_Number'))
      {
    ...
    return (
      ...
      <div className="mx-auto w-full max-w-lg ">
        <h1 className="text-4xl font-bold text-center text-white">Add Instructors</h1>
